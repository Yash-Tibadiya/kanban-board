...
export function TaskDetailsSheet({
  ...
  return (
    <Sheet open={isOpen} onOpenChange={onClose}>
      <SheetContent className="w-[400px] sm:w-[700px] overflow-y-auto sm:p-0 rounded-none border-l-0 gap-0">
        <div className="px-4 pt-4">
          <SheetHeader className="space-y-3">
            ...
            <SheetDescription className="flex flex-col items-start text-sm text-muted-foreground">
              {task.user && (
                <>
              ...
              <span className="flex items-center gap-1.5 text-xs font-medium pt-2">
                <span className="text-muted-foreground/60 font-normal">
                  Created :
                </span>
        ...
        <div className="bg-muted/30 p-6 min-h-[300px]">
